...
import { AdressesStackNavigator, AllergicStackNavigator, BookCateringStackNavigator, CategoryStackNavigator, CheckoutInfoStackNavigator, CheckoutStackNavigator, ContactUsStackNavigator, ContainersStackNavigator, DashboardStackNavigator, DonateStackNavigator, FaqStackNavigator, GiftCardsStackNavigator, MyCartStackNavigator, MyOrderstackNavigator, MyProfilestackNavigator, NutritionPackagesStackNavigator, PasswordstackNavigator, PickupStackNavigator, ReferStackNavigator, WelcomeStackNavigator, WellnessstackNavigator } from "./RootStack";
  ...
  return (
    ...
    >
     ...
     <Tab.Screen 
      ...
      <Tab.Screen 
      name="Password" component={PasswordstackNavigator}
      options={{ tabBarItemStyle: { display: 'none', }, }}
      />

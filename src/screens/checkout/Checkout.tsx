    ...
    <View style={styles.container}>
      <View style={styles.wrapper}>
           <View style={styles.textDivide}>
            ...
            <TouchableOpacity activeOpacity={.7} style={styles.saveButtom} onPress={()=>navigation.navigate('CheckoutInfo')}>
                <Text style={styles.saveButtomText}>Pay $33.36</Text>
            </TouchableOpacity>
            <View style={{marginTop: 30}}>
                <Text style={styles.bottomText}>Your card will be immediately charged 
                <Text style={styles.bottomTextTotal}> $164.71.</Text></Text>
            </View>
      </View>
    </View>
  )
